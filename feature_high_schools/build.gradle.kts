...
dependencies {
  ...
  implementation(Libs.Android.Main.mapsKtx)
  implementation(Libs.Android.Main.mapsUtilsKtx)
  implementation(Libs.Android.Main.playServiceMaps)
  implementation(Libs.Android.Main.mapsUtils)
